...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        arcadeVC.title = "Arcade"
        arcadeVC.tabBarItem.title = "Arcade"
        arcadeVC.tabBarItem.image = UIImage(systemName: "dollarsign.circle")
        ...
        tbc.viewControllers = [appsVC, gamesVC, arcadeVC, searchVC]
//        tbc.setViewControllers([appsVC, gamesVC, arcadeVC, searchVC], animated: true)
